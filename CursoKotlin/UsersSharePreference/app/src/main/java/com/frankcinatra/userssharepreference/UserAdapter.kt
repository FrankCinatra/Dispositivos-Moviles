...
import com.frankcinatra.userssharepreference.databinding.ItemUserAlternBinding
...
class UserAdapter(private val users: List<User>, private val listener: OnClickListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(context).inflate(R.layout.item_user_altern, parent, false)
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view){
        val binding = ItemUserAlternBinding.bind(view)
